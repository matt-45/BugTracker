...
namespace BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Property,NewValue,OldValue,Changed,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Property,NewValue,OldValue,Changed,UserId")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
