...
namespace BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,TicketId,IsRead,NotificationBody,Sent")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,TicketId,IsRead,NotificationBody,Sent")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
